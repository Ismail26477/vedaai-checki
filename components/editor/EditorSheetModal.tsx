...
import { Plus, Calendar, Link2, Trash2, FileText, Clock } from "lucide-react"
...
interface EditorSheetModalProps {
  sheetId: string | null
  isOpen: boolean
  onClose: () => void
}

export function EditorSheetModal({ sheetId, isOpen, onClose }: EditorSheetModalProps) {
